...
if(isset($_SESSION["progpass"]) && isset($_SESSION["proguser"]))
    echo "<script>window.open('prog1.php','_self')</script>";
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="prog1.php" method="post">
    
    <div class="container">
    	<p style="font-size: 30px; text-align: center; font-style: italic;"><b>Programmer Login</b></p>
